    ...
    <div className="mt-12">
        ...
        <div className="text-sm w-full md:w-1/2">
          ...
          <div className="flex items-center mt-10 gap-4 text-base">
            ...
            <button
              ...
              className="w-full py-3.5 cursor-pointer font-medium text-white bg-[#24a47c] hover:bg-[#1e8c69] transition"
            >
              Buy now
            </button>
          </div>
      ...
      <div className="flex flex-col items-center mt-20">
        <div className="flex flex-col items-center w-max">
          ...
          <div className="w-20 h-0.5 bg-[#24a47c] rounded-full mt-2"></div>
        </div>
        ...
        {relatedProducts.length > 0 ? (
          <>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 mt-6 w-full">
              {relatedProducts
                .filter((p) => p.inStock)
                .map((p, index) => (
                  <ProductCard key={index} products={p} />
                ))}
            </div>
            <button
              onClick={() => {
          ...
          <p className="mt-8 text-gray-500">No related products found.</p>
        )}
      </div>
    </div>
  ) : (
